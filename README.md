...
- **Client SDKs** — TypeScript (`@wavehouse/sdk`) and Go (`github.com/Wave-RF/WaveHouse/clients/go`): zero-dependency clients with query builder, live queries, streaming, and schema codegen.
