...
- **Client SDKs** — TypeScript (`@wavehouse/sdk`) and Go (`github.com/Wave-RF/WaveHouse/clients/go`): query builder, live queries, streaming, and schema codegen in both. TypeScript has one runtime dependency (an SSE frame parser, ~1.4 KB gzipped); Go has none.
