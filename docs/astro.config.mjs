...
posthog.init('phc_xFG2NGQa7bFg4QjBp3MAn8kr8bAPJxM7GvKzfoNEwZwj',{api_host:'https://us.i.posthog.com',defaults:'2026-01-30'});`,
        ...
        // Note: /favicon.ico is still emitted by `make branding` and lives
        // in public/ — legacy clients (older IE/Edge, some RSS readers) that
        // can't read the SVG favicon will auto-probe /favicon.ico from the
        // site root by convention, so no explicit <link> tag is needed.
        // iOS home-screen icon — solid teal background, 180×180.
        { tag: "link", attrs: { rel: "apple-touch-icon", sizes: "180x180", href: "/apple-touch-icon.png" } },
        // Open Graph image — Starlight already emits og:title / og:description
        // and twitter:card=summary_large_image, but no og:image. Drop a
        // 1200×630 PNG at `docs/public/og.png` and link-preview surfaces
        // (Slack, Discord, Twitter, iMessage, …) will pick it up. Absolute
        // URL is required by most scrapers.
