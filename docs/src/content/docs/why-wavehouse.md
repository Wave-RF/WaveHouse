...
| Client SDK | Each team writes one | Official [TypeScript and Go clients](/sdk) — query builder, live queries, typed rows |
...
| Type-safe client SDK | ✗ | Per team | Partial | ✓ TypeScript + Go SDKs |
