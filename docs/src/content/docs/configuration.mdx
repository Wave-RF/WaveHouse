...
```yaml
data_dir: ./data         # nats → ./data/nats, dedupe → ./data/<tenant>/dedupe
                         # (./data/0/dedupe for the four-file settings directory)
