...
```bash title="wavehouse.env"
export WH_DATA_DIR=./data

export WH_SERVER_PORT=8080
export WH_SERVER_SHUTDOWN_TIMEOUT=10
export WH_SERVER_CORS_ALLOWED_ORIGINS=*

export WH_CH_ADDR=localhost:9000
export WH_CH_HTTP_PORT=8123
export WH_CH_HTTP_SCHEME=http
export WH_CH_DATABASE=default
export WH_CH_USERNAME=default
export WH_CH_PASSWORD=
export WH_CH_QUERY_TIMEOUT=30s

export WH_MQ_GAP_WINDOW_MINUTES=15
export WH_MQ_MAX_BYTES_GB=50

export WH_DEDUPE_ENABLED=false
export WH_DEDUPE_ID_FIELD=event_id

export WH_CACHE_L1_MAX_COST=67108864
export WH_CACHE_TIMESTAMP_BUCKET_SECONDS=60

export WH_AUTH_JWT_SECRET=change-me-in-production
export WH_AUTH_JWKS_URL=
export WH_AUTH_ROLE_CLAIM=role

export WH_SCHEMA_REFRESH_INTERVAL=60

export WH_DLQ_ENABLED=true

export WH_POLICY_FILE_PATH=

export WH_PIPES_DIR=

export WH_OTEL_ENABLED=false
export WH_OTEL_ADDR=127.0.0.1:4317
export WH_OTEL_TRACES_ENABLED=true
export WH_OTEL_TRACES_SAMPLE_RATE=1.0
export WH_OTEL_METRICS_ENABLED=true
export WH_OTEL_LOGS_ENABLED=true
export WH_OTEL_LOGS_SAMPLE_RATE=1.0

export WH_PROMETHEUS_ENABLED=false
export WH_PROMETHEUS_PATH=/metrics
export WH_PROMETHEUS_PORT=0
```
</TabItem>
</Tabs>
