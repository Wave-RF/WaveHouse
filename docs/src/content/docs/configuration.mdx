...
- **A bad edit can't take the server down.** If the edited file fails to parse or validate, the reload returns an error and the previous config stays fully active.
