...
This page is boot config only — what the platform operator owns (wiring, lifecycle, secrets), read once at startup. Tenant-owned behavioral tunables are not here: they live in the hot-reloadable [Settings Directory](/settings-directory).
