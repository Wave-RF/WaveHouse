...
The access-control policy — one [policy document](/access-control#anatomy-of-a-policy) (`default_role`, `admin_role`, `tables`), the same shape `GET /v1/ops/policy` returns:
