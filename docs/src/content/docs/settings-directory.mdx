...
| `dedupe.retention` | `"0"` | How long a committed id stays a duplicate, as a duration (`"720h"`); `"0"` keeps it forever — see [Deduplication](#deduplication). |
