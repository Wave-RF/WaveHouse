...
goes out. The upstream report measured ~450–465 ms against a 10 ms server; our
own measurements on 8.9.0 saw it swing erratically from ~100 ms to ~2.5 s
depending on the idle gap. It affects undici 8.8.0–8.9.0, and Node 26 bundles
8.9.0.
