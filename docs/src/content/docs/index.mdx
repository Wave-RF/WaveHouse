...
<CardGrid>
 ...
 <Card title="TypeScript & Go SDKs" icon="seti:typescript">
  `@wavehouse/sdk` and `github.com/Wave-RF/WaveHouse/clients/go` — type-safe query builders, live queries, real-time streaming, and typed rows, speaking one shared wire format.
 </Card>
</CardGrid>
...
<CardGrid>
 ...
 <LinkCard
  title="Client SDKs"
  description="TypeScript and Go — query builder, live queries, streaming, and typed rows."
  href="/sdk"
 />
</CardGrid>
