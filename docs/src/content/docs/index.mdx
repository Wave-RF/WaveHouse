...
description: The open-source real-time API gateway for ClickHouse — schema-aware ingest, async batching, real-time streaming, and tiered query caching in one binary.
template: splash
...
hero:
  title: WaveHouse
  tagline: The open-source real-time API gateway for ClickHouse. Schema-aware ingest, async batching, real-time streaming, and tiered query caching — in one binary.
  actions:
    - text: Read the docs
