...
<div class="wh-stats not-content">
  ...
  <div class="wh-stat">
    ...
    <span class="wh-stat__label">cached query path, p99</span>
  </div>
  <div class="wh-stat">
...
One container — ClickHouse and WaveHouse both — and you have an ingest endpoint, a query endpoint, and a live event stream:
...
curl -N http://localhost:8088/v1/stream/events
```
