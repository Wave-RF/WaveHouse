...
func TestCanonicalizeTimestamps(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			resolveTimestampSpecs(t.Context(), schema, tt.serverTZ)
...
func TestColumnTimeParser(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			schema := tsSchema(tt.colType)
			resolveTimestampSpecs(t.Context(), schema, nil)
...
func TestCanonicalizeTimestamps_AbsentColumn(t *testing.T) {
	...
	resolveTimestampSpecs(t.Context(), schema, time.UTC)
...
func TestResolveTimestampSpecs(t *testing.T) {
	...
	resolveTimestampSpecs(t.Context(), schema, nyc)
...
func TestRefresh_PrecomputesSpecs(t *testing.T) {
	...
	reg := NewSchemaRegistry(connOf(conn), func() string { return "test" }, tenant.Default, func(tenant.ID) time.Duration { return time.Hour })
