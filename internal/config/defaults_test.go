...
var zeroCases = []zeroCase{
	...
	{"dedupe.lease", "WH_DEDUPE_LEASE", time.Duration(0), 30 * time.Second, "10s", 10 * time.Second, func(c *Config) any { return c.Dedupe.Lease }},
	{"dedupe.reserve_concurrency", "WH_DEDUPE_RESERVE_CONCURRENCY", 0, 64, "8", 8, func(c *Config) any { return c.Dedupe.ReserveConcurrency }},
	{"dedupe.dynamodb.timeout", "WH_DEDUPE_DYNAMODB_TIMEOUT", time.Duration(0), 250 * time.Millisecond, "1s", time.Second, func(c *Config) any { return c.Dedupe.DynamoDB.Timeout }},
	{"dedupe.dynamodb.max_attempts", "WH_DEDUPE_DYNAMODB_MAX_ATTEMPTS", 0, 3, "5", 5, func(c *Config) any { return c.Dedupe.DynamoDB.MaxAttempts }},
	{"dedupe.dynamodb.retry_mode", "WH_DEDUPE_DYNAMODB_RETRY_MODE", "", "standard", "adaptive", "adaptive", func(c *Config) any { return c.Dedupe.DynamoDB.RetryMode }},
