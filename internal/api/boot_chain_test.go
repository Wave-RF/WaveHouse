...
func TestBoot_Chain_DegradedThenRecovers(t *testing.T) {
	...
	registry := discovery.NewSchemaRegistry(func() driver.Conn { return conn }, func() string { return "test" }, tenant.Default, func(tenant.ID) time.Duration { return time.Hour })
